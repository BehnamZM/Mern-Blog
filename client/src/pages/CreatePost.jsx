  ...
  return (
    <DashboardLayout>
      <div className="w-full my-5 flex flex-col items-center justify-center ">
        ...
        <form className="p-3 my-2 rounded-lg bg-blue-100 w-2/3  mx-auto flex flex-col items-center justify-center gap-2">
          <input
            type="text"
          ...
          <div className="flex justify-between w-full p-3 border-4 border-dotted border-white">
            <input
              type="file"
